      ...
      <div className="relative isolate overflow-hidden bg-white py-1 sm:py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-5xl font-bold tracking-tight text-gold-goldTitle sm:text-5xl lg:text-6xl">¿Qué es el renting?</h2>
            <p className="mt-6 text-2xl text-slate-900">
